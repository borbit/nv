 ...
 *
 */
utils.loadProdAssets = function(assetsMapPath, imagesMapPath, cb) {
  utils.loadJSON(assetsMapPath, function(err, assetsMap) {
    utils.loadJSON(imagesMapPath, function(err, imagesMap) {
      cb(null, {assets: assetsMap, images: imagesMap})
    });
  });
};
